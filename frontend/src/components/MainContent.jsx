  ...
  return (
    <main id="todo-main-content">
      <header>
        ...
        >
          <h2 id="edit-folder-dialog-title" className="sr-only">
            Edit Folder Name
          </h2>
          <SlInput
        ...
        >
          <h2 id="delete-folder-dialog-title" className="sr-only">
        ...
        <form className="actions" onSubmit={handleAddTodo} autoComplete="off">
          ...
          />
          <button id="add-todo-btn" type="submit" aria-label="Add items">
            Add Items
          </button>
        </form>
      </header>
